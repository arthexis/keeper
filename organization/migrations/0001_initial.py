# Generated by Django 2.0.2 on 2018-02-27 16:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_code', django_extensions.db.fields.AutoSlugField(blank=True, editable=False, populate_from='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chronicle_name', models.CharField(blank=True, max_length=100)),
                ('short_description', models.TextField(blank=True)),
                ('reference_code', django_extensions.db.fields.AutoSlugField(blank=True, editable=False, populate_from=('name', 'chapter__name'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invitations', to='organization.Chapter')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prestige_levels', to='organization.Chapter')),
            ],
            options={
