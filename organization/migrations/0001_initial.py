# Generated by Django 2.0.2 on 2018-02-28 13:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_code', django_extensions.db.fields.AutoSlugField(blank=True, editable=False, populate_from=('name', 'organization__name'))),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prestige', to='organization.Organization')),
            ],
            options={
