# Generated by Django 2.0.2 on 2018-02-15 18:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='systems.CharacterTemplate')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20)),
                ('character_template', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='power_categories', to='systems.CharacterTemplate')),
            ],
            options={
