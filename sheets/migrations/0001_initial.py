    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience_cost', models.PositiveSmallIntegerField(choices=[(4, 'Attribute = 4 XP'), (2, 'Skill = 2 XP'), (1, 'Merit / Power = 1 XP per dot'), (5, 'Power Stat = 5 XP'), (0, 'Prestige / Other = No XP')], default=0)),
        ...
        migrations.AddField(
            model_name='approvalrequest',
            name='prestige_level',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='organization.PrestigeLevel'),
        ),
        migrations.AddField(
            model_name='approvalrequest',
            name='user',
