    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(db_index=True, editable=False, null=True)),
                ('experience_cost', models.PositiveSmallIntegerField(default=0, help_text='Base Experiences cost based on the trait type.', verbose_name='Exp. Cost')),
                ('quantity', models.PositiveSmallIntegerField(default=1, help_text='Number of total dots being requested.')),
                ('total_cost', models.PositiveSmallIntegerField(default=0, editable=False, help_text='Total Experiences cost. Calculated automatically.')),
                ('detail', models.CharField(blank=True, help_text='Indicate which specific trait or approval you are requesting.', max_length=100)),
                ('additional_information', models.TextField(blank=True, verbose_name='Additional Information')),
                ('prestige_level', models.PositiveSmallIntegerField(default=0, help_text='Used to specify that this request is for a Prestige reward.')),
