    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response', models.TextField(blank=True, default='Granted.', verbose_name='Response Details')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_changed', model_utils.fields.MonitorField(default=django.utils.timezone.now, monitor='status', verbose_name='status changed')),
                ('name', models.CharField(max_length=40, verbose_name='Name or Alias')),
                ...
                ('size', systems.fields.DotsField(default=5, editable=False)),
